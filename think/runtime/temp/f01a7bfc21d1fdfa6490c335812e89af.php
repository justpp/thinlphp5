<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:80:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\article\add.html";i:1513683413;s:75:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\layout.html";i:1512638527;s:82:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\public\header.html";i:1512717201;s:80:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\public\left.html";i:1513647025;s:82:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\public\footer.html";i:1512609878;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <div class="col-sm-9">
                        <select name="mid" class="col-xs-10 col-sm-5">
                            ...
                            <?php if (is_array($mlist) || $mlist instanceof \think\Collection || $mlist instanceof \think\Paginator): $i = 0;
                                ...
                                else: foreach ($__LIST__ as $key => $m): $mod = ($i % 2);
                                    ++$i; ?>
                    ...
                    <div class="col-sm-9">
                        <select name="tpl" class="col-xs-10 col-sm-5">
                            ...
                            <?php if (is_array($files) || $files instanceof \think\Collection || $files instanceof \think\Paginator): $i = 0;
                                $__LIST__ = $files;
                                if (count($__LIST__) == 0) : echo "";
                                else: foreach ($__LIST__ as $key => $f): $mod = ($i % 2);
                                    ++$i; ?>
