<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:82:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\product\index.html";i:1513684875;s:75:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\layout.html";i:1512638527;s:82:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\public\header.html";i:1512717201;s:80:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\public\left.html";i:1513647025;s:82:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\public\footer.html";i:1512609878;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
    ...
    <div class="main-content">
        ...
        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
            <thead>
            <button class="btn">
                <a href="<?php echo url('product/add'); ?>"><i class="ace-icon fa fa-pencil align-top bigger-125"></i>
                    添加记录</a>
            </button>
            <form action="<?php echo url('product/del'); ?>" method="post">
                <tr>
                    <th class="center">
            ...
            <tr>
                ...
                <td class="hidden-480"><?php echo $c['attr']; ?></td>
                <td><?php echo $c['usein']; ?></td>

                <td class="hidden-480">
                    <span><?php echo date('Y-m-d H:i:s', $c['addtime']); ?></span>
                </td>
                <td>
                    <a href="<?php echo url('product/modfi', ['id' => $c['id']]); ?>" class="modf">修改</a>
                    <a href="<?php echo url('product/del', ['id' => $c['id']]); ?>" class="dels">删除</a>
    </div>
    </td>
    </tr>
