<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:96:"D:\phpstudy\PHPTutorial\WWW\1206\thinlphp5\think\public/../application/index\view\cate\news.html";i:1514119852;s:100:"D:\phpstudy\PHPTutorial\WWW\1206\thinlphp5\think\public/../application/index\view\public\header.html";i:1514119849;s:100:"D:\phpstudy\PHPTutorial\WWW\1206\thinlphp5\think\public/../application/index\view\public\footer.html";i:1513307705;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8"/>
...
<script>
    $(function () {
        ...
        $(".new_box ul li:odd").find("img").css("float", "right");
        $(".new_box ul li").hover(function () {
            $(this).addClass("active");
        }, function () {
            $(this).removeClass("active");
        });
