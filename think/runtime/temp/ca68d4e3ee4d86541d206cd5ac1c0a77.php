<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:79:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\news\modfi.html";i:1513681869;s:75:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\layout.html";i:1512638527;s:82:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\public\header.html";i:1512717201;s:80:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\public\left.html";i:1513647025;s:82:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\public\footer.html";i:1512609878;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="thumb"
                                        ...
                                        <img src="<?php echo $list['thumb']; ?>" width="160" height="160"
                                             onerror="this.src='__STATIC__/images/101.jpg'">
                                    </div>
                                    <input type="hidden" id="url1" name="thumb" value="<?php echo $list['thumb']; ?>">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"
                                       for="form-input-readonly">描述： </label>

                                <div class="col-sm-10">
                                    <input type="text" class="col-xs-10 col-sm-5" id="form-input-readonly"
                                           name="description" value="<?php echo $list['title']; ?>">
                                </div>
                            </div>
                                ...
                                <div class="col-sm-10">
                                    <div class="pos-rel">
                                        <textarea class="form-control " id="editor_id2" maxlength="40"
                                                  ...
                                                  name="content"><?php echo $list['content']; ?></textarea>
                                    </div>
                                </div>
                            </div>
