<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:80:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\admin\index.html";i:1512628625;s:75:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\layout.html";i:1512638527;s:82:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\public\header.html";i:1512717201;s:80:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\public\left.html";i:1513647025;s:82:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\public\footer.html";i:1512609878;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="page-content">
            ...
            <div class="page-content-area">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <!-- PAGE CONTENT BEGINS -->
                        <form class="form-horizontal" role="form" action="<?php echo url('admin/index'); ?>"
                              method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="col-xs-10 col-sm-5" id="form-input-readonly"
                                           name="username" value="<?php echo session('userName'); ?>"/>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" id="form-field-1" placeholder="密码" class="col-xs-10 col-sm-5"
                                           name="word"/>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input type="password" id="form-field-1-1" placeholder="确认密码"
                                           class=" col-xs-10 col-sm-5" name="rpword"/>
                                </div>
                            </div>
