<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\login\index.html";i:1512620462;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" style="margin-top:13%">
                                ...
                                <div class="widget-main">
                                    ...
                                    <form action="<?php echo url('Login/dologin'); ?>" method="post">
                                        <fieldset>
                                            ...
                                            <label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input type="text" name="verc" class="form-control"
                                                                   placeholder="验证码"/>
															<i class="ace-icon fa fa-flag"></i>
														</span>
                                            </label>
                                            <div><img src="<?php echo captcha_src(); ?>" alt="看不清，换" title="看不清换"
                                                      id="captcha" style="cursor:pointer;"></div>
                                            <div class="space"></div>
