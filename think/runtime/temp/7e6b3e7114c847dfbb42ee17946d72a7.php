<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:100:"D:\phpstudy\PHPTutorial\WWW\1206\thinlphp5\think\public/../application/admin\view\modell\modfie.html";i:1514133799;s:93:"D:\phpstudy\PHPTutorial\WWW\1206\thinlphp5\think\public/../application/admin\view\layout.html";i:1514119849;s:100:"D:\phpstudy\PHPTutorial\WWW\1206\thinlphp5\think\public/../application/admin\view\public\header.html";i:1514119852;s:98:"D:\phpstudy\PHPTutorial\WWW\1206\thinlphp5\think\public/../application/admin\view\public\left.html";i:1514119853;s:100:"D:\phpstudy\PHPTutorial\WWW\1206\thinlphp5\think\public/../application/admin\view\public\footer.html";i:1514126568;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="col-xs-12">
            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="输入字段名" class="col-xs-9 col-sm-5" name="name"
                               value="<?php echo $info['name']; ?>">
                    </div>
                </div>
                <div class="space-4"></div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">字段说明：</label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="输入字段说明" class="col-xs-10 col-sm-5" name="detail"
                               value="<?php echo $info['detail']; ?>">
                    </div>
                </div>
                <div class="space-4"></div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">数据类型：</label>
                    <div class="col-sm-9">
                        <select class="col-xs-10 col-sm-5" name="type">
                            <option value="varchar">字符串类型(varchar)</option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <input type="text" placeholder="输入字段长度" class="col-xs-10 col-sm-5" name="length"
                               value="<?php echo $info['length']; ?>">
                    </div>
                </div>
                <div class="space-4"></div>
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <select class="col-xs-10 col-sm-5" name="isnull">
