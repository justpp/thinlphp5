<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:98:"D:\phpstudy\PHPTutorial\WWW\1206\thinlphp5\think\public/../application/admin\view\article\add.html";i:1514119850;s:93:"D:\phpstudy\PHPTutorial\WWW\1206\thinlphp5\think\public/../application/admin\view\layout.html";i:1514119849;s:100:"D:\phpstudy\PHPTutorial\WWW\1206\thinlphp5\think\public/../application/admin\view\public\header.html";i:1514119852;s:98:"D:\phpstudy\PHPTutorial\WWW\1206\thinlphp5\think\public/../application/admin\view\public\left.html";i:1514119853;s:100:"D:\phpstudy\PHPTutorial\WWW\1206\thinlphp5\think\public/../application/admin\view\public\footer.html";i:1514126568;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="col-xs-12">
            <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" placeholder="输入名称" class="col-sm-9 col-sm-5" name="cname">
                    </div>
                </div>
                <div class="space-4"></div>
                <div class="form-group">
                ...
                <div class="space-4"></div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">所属频道：</label>
                    <div class="col-sm-9">
                        <select name="mid" class="col-xs-10 col-sm-5">
                            <option value="">请选择</option>
                            <?php if (is_array($mlist) || $mlist instanceof \think\Collection || $mlist instanceof \think\Paginator): $i = 0;
                                $__LIST__ = $mlist;
                                if (count($__LIST__) == 0) : echo ""; else: foreach ($__LIST__ as $key => $m): $mod = ($i % 2);
                                    ++$i; ?>
                                    <option value="<?php echo $m['id']; ?>"
                                            data-name="<?php echo $m['name']; ?>"><?php echo $m['detail']; ?></option>
                ...
                <div class="space-4"></div>
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right">前台模板：</label>
                    <div class="col-sm-9">
                        <select name="tpl" class="col-xs-10 col-sm-5">
                            <option value="">请选择</option>
                            <?php if (is_array($files) || $files instanceof \think\Collection || $files instanceof \think\Paginator): $i = 0;
                                $__LIST__ = $files;
                                if (count($__LIST__) == 0) : echo ""; else: foreach ($__LIST__ as $key => $f): $mod = ($i % 2);
                                    ++$i; ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="radio">
                            <label>
                                <input type="radio" name="type" value="1" checked class="ace">
                                <span class="lbl">列表</span>
                            </label>
                            <label>
                                <input type="radio" name="type" value="2" class="ace">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="thumb" style="width:160px;margin-bottom:10px;background:#f1f1f1">
                            <img src="" width="160" onerror="this.src='__STATIC__/images/101.jpg'">
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div class="pos-rel">
                            <textarea class="form-control" style="height:300px" name="content" id="editor"></textarea>
                        </div>
                    </div>
                </div>
            ...
            <script src="__STATIC__/assets/kindeditor/kindeditor-all.js"></script>
            <script src="__STATIC__/assets/kindeditor/lang/zh-CN.js"></script>
            <script>
                //产品介绍
