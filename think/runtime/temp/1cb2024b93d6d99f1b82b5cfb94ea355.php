<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:82:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\product\modfi.html";i:1513685891;s:75:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\layout.html";i:1512638527;s:82:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\public\header.html";i:1512717201;s:80:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\public\left.html";i:1513647025;s:82:"D:\phpStudy\WWW\PHP\1206\think\public/../application/admin\view\public\footer.html";i:1512609878;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="thumb"
                                        ...
                                        <img src="<?php echo $mdo['thumb']; ?>" width="160" height="160"
                                             onerror="this.src='__STATIC__/images/101.jpg'">
                                    </div>
                                    <input type="text" id="url1" name="thumb" value="<?php echo $mdo['thumb']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" id="form-field-2" placeholder="输入规格" class="col-xs-10 col-sm-5"
                                           name="attr" value="<?php echo $mdo['attr']; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div id="J_imageView">
                                        <?php if ($mdo['imgs']): if (is_array($mdo['imgs']) || $mdo['imgs'] instanceof \think\Collection || $mdo['imgs'] instanceof \think\Paginator): $i = 0;
                                            $__LIST__ = $mdo['imgs'];
                                            if (count($__LIST__) == 0) : echo "";
                                            else: foreach ($__LIST__ as $key => $im): $mod = ($i % 2);
                                                ++$i; ?>
                                                <div class="item">
                                                    <img src="<?php echo $im; ?>" width="100" height="100">
                                                    <input type="hidden" name="imgs[]" value="<?php echo $im; ?>">
                            ...
                            <textarea class="form-control " id="editor_id2" maxlength="40"
                                      ...
                                      name="bestin"><?php echo $mdo['bestin']; ?></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <textarea class="form-control limited autosize-transition" id="editor_id"
                                      ...
                                      height: 80px;" name="content"><?php echo $mdo['content']; ?></textarea>
                                    </div>
                                </div>
                            </div>
